<?php 
    ...
    if(isset($_POST['nom_entreprise']) && ($_POST['nom_entreprise']) && isset($_POST['duree_stage']) && isset($_POST['date_offre']) && isset($_POST['base_remuneration']) && isset($_POST['nb_place']) && isset($_POST['nb_stagiaire_accepte']) && isset($_POST['domaine_stage']) && isset($_POST['email_contact']) && isset($_POST['description_stage']))
    ...
    
    {
        ...
        if($row == 0){ 
                            ...
                            $insert_stage = $bdd->prepare('INSERT INTO offres_de_stages(competences,	nom_entreprises,	duree_du_stage,	base_de_remuneration,	date_de_l_offre	,nombre_de_places_offertes_aux_etudiants,	Nombres_de_stagieres_acceptes	,Domaine_du_stage,	adresse_mail_stages	,ID_entreprises	) VALUES(:competences, :nom_entreprise, :duree_stage, :base_remuneration, :date_offre, :nb_place, :nb_stagiaire_accepte, :domaine_stage,:email_contact,  :id_entreprise) ');
