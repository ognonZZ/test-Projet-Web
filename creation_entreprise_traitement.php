<?php 
    ...
    if(isset($_POST['nom_entreprise']) && isset($_POST['secteur_activite']) && isset($_POST['nb_stagiaire_accepte']) && isset($_POST['voie']) && isset($_POST['rue']) && isset($_POST['ville']) && isset($_POST['code_postal']) && isset($_POST['description_entreprise']))
    {
        ...
        if($row == 0){ 
                            ...
                            $insert_entreprise = $bdd->prepare('INSERT INTO entreprises(Nom_entreprises, Description_de_l_entreprise, Secteur_D_avctivite, Nombres_de_stagiaires_CESI_deja_acceptes_en_stage, ID_localites, ID_localites_Situer) VALUES(:nom_entreprise, :description_entreprise, :secteur_activite, :nb_stagiaire_accepte, :id_localites, :id_localites2) ');
