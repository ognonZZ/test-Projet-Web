...
<div class="section">
    <div class="row text">
        ...
        <div class="col-6 slogan">
            ...
            <legend><b>Modification d'une offre de stage</b></legend>
                <form class="needs-validation" action="modification_stage_traitement.php" method="post" novalidate >
                ...
                <input type="hidden" name="stage_id2" value= <?php echo $id2; ?> >
                    ...
                    <button class="btn btn-primary" type="submit">Modififer Offre de Stage</button>
                </form>
        </fieldset>
        </div>
